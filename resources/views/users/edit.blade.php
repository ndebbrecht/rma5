...
@section('content')
{!! Form::model($user, array('url' => array('users/edit', $user->id))) !!}
    <h2 class="form-signup-heading">Student bearbeiten</h2>
    ...
    {!! Form::text('birthdate', null, array('class'=>'form-control', 'placeholder'=>'Datum')) !!}          
